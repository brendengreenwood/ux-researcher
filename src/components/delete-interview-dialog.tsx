...
export function DeleteInterviewDialog({
  ...
  async function handleDelete() {
    ...
    try {
      ...
      alert(`Error deleting interview: ${err instanceof Error ? err.message : 'Unknown error'}`)
      setLoading(false)
    }
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            You are about to permanently delete the interview "{interviewTitle}" and all associated recordings, annotations, and analysis. This is irreversible.
          </AlertDescription>
        </Alert>
